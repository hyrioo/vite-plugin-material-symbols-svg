...
export { defineIcons, getSymbol, registerSymbol, unregisterSymbol, registerRawSymbol, registerMultipleSizes, autoRegisterCustom, } from './registry';
export type { OpticalSize, Weight, Fill, Theme, IconConfig, DefinedIcons, } from './registry';
